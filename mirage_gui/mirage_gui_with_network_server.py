...
class SciCamGUI(QWidget):
    ...
    def process_remote_command(self, command):
        ...
        try:
            ...
            if cmd_type == "CAPTURE":
                ...
                response = {
                    "status": "success",
                    "message": f"Exposure set to {exp_time}s",
                }
                ...
                if os.path.exists(path):
                    ...
                    response = {"status": "error", "message": "Path does not exist"}
    ...
    def setup_ui(self):
        ...
        default_folder = os.path.join(os.path.expanduser("~"), "data")
    ...
    def browse_folder(self):
        ...
        if not current_path or not os.path.exists(current_path):
            current_path = os.path.join(os.path.expanduser("~"), "data")
